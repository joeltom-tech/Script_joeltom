...
function add_hy2() {
  ...
  echo -e "${CY}╔════════════════════════════════════════════════════════════╗${NC}"
  echo -e "${CY}║${NC}                                                            ${CY}║${NC}"
  echo -e "${CY}║${NC}             🚀 ${WHITE}CRÉER UN COMPTE HYSTERIA2${NC} 🚀           ${CY}║${NC}"
  echo -e "${CY}║${NC}                    💻 ${WHITE}𝑴𝑹 𝑻𝑶𝑴${NC} 💻                       ${CY}║${NC}"
  echo -e "${CY}║${NC}                                                            ${CY}║${NC}"
  echo -e "${CY}╚════════════════════════════════════════════════════════════╝${NC}"
  ...
  grep -qw "$user" "$DB" 2>/dev/null && {
    echo -e "${RED} ❌ Existe déjà.${NC}"
    sleep 2
    hy2_menu
    return
  }
  ...
  echo -e "${GREEN}║${NC}              🎉 ${WHITE}COMPTE CRÉÉ AVEC SUCCÈS${NC} 🎉             ${GREEN}║${NC}"
  echo -e "${GREEN}║${NC}                    💻 ${WHITE}𝑴𝑹 𝑻𝑶𝑴${NC}                          ${GREEN}║${NC}"
  echo -e "${GREEN}║${NC}                                                            ${GREEN}║${NC}"
  echo -e "${GREEN}╚════════════════════════════════════════════════════════════╝${NC}"

  echo ""
  echo -e " 👤 ${WHITE}Utilisateur :${NC} ${GREEN}${user}${NC}"
  echo -e " 📅 ${WHITE}Expiration  :${NC} ${GREEN}${exp}${NC}"
  echo ""
  echo -e " 🔗 ${CY}${link}${NC}"
  echo ""
...
function list_hy2() {
  ...
  echo -e "${CY}╔════════════════════════════════════════════════════════════╗${NC}"
  echo -e "${CY}║${NC}                                                            ${CY}║${NC}"
  echo -e "${CY}║${NC}             👥 ${WHITE}UTILISATEURS HYSTERIA2${NC} 👥               ${CY}║${NC}"
  echo -e "${CY}║${NC}                    💻 ${WHITE}𝑴𝑹 𝑻𝑶𝑴${NC}                          ${CY}║${NC}"
  echo -e "${CY}║${NC}                                                            ${CY}║${NC}"
  echo -e "${CY}╚════════════════════════════════════════════════════════════╝${NC}"
...
function delete_hy2() {
  ...
  echo -e "${RED}║${NC}              🗑️ ${WHITE}SUPPRIMER UN COMPTE${NC} 🗑️                ${RED}║${NC}"
  echo -e "${RED}║${NC}                    💻 ${WHITE}𝑴𝑹 𝑻𝑶𝑴${NC}                          ${RED}║${NC}"
  echo -e "${RED}║${NC}                                                            ${RED}║${NC}"
  echo -e "${RED}╚════════════════════════════════════════════════════════════╝${NC}"
  ...
  read -rp " 🗑️ Nom d'utilisateur à supprimer : " user
...
function hy2_menu() {
  ...
  echo -e "${CY}╔════════════════════════════════════════════════════════════╗${NC}"
  echo -e "${CY}║${NC}                                                            ${CY}║${NC}"
  echo -e "${CY}║${NC}                🚀 ${WHITE}HYSTERIA2 MANAGER${NC} 🚀                 ${CY}║${NC}"
  echo -e "${CY}║${NC}                    💻 ${WHITE}𝑴𝑹 𝑻𝑶𝑴${NC}                          ${CY}║${NC}"
  echo -e "${CY}║${NC}                                                            ${CY}║${NC}"
  echo -e "${CY}╚════════════════════════════════════════════════════════════╝${NC}"
  ...
  echo -e "${CY}╭────────────────────────────────────────────────────────────╮${NC}"
  echo -e "${CY}│${NC}                  🌐 ${WHITE}ACCOUNT MANAGER${NC}                    ${CY}│${NC}"
  echo -e "${CY}├────────────────────────────────────────────────────────────┤${NC}"

  echo -e "${CY}│${NC}  ${GREEN}[01]${NC} 👤 Créer un compte       ${GREEN}[03]${NC} 👥 Utilisateurs actifs"
  echo -e "${CY}│${NC}  ${RED}[02]${NC} 🗑️ Supprimer"
  echo -e "${CY}│${NC}"
  echo -e "${CY}│${NC}  ${WHITE}[00]${NC} 🔙 Retour au menu principal"
