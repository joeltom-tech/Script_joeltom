...
echo -e "${LN}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${LN}║${NC}                                                            ${LN}║${NC}"
echo -e "${LN}║${NC}                 🌐 ${GR}IPv6 MANAGER${NC} 🌐                       ${LN}║${NC}"
echo -e "${LN}║${NC}                    💻 𝑴𝑹 𝑻𝑶𝑴 💻                           ${LN}║${NC}"
echo -e "${LN}║${NC}                                                            ${LN}║${NC}"
echo -e "${LN}╚════════════════════════════════════════════════════════════╝${NC}"
...
echo -e "${LN}╭────────────────────────────────────────────────────────────╮${NC}"
echo -e "${LN}│${NC}  📡 ${WH}État actuel :${NC} ${ipv6_status}"
echo -e "${LN}│${NC}"
echo -e "${LN}│${NC}  ${GR}[01]${NC} 🟢 Activer IPv6"
echo -e "${LN}│${NC}  ${GR}[02]${NC} 🔴 Désactiver IPv6"
echo -e "${LN}│${NC}"
echo -e "${LN}│${NC}  ${RD}[00]${NC} 🔙 Retour au menu principal"
echo -e "${LN}╰────────────────────────────────────────────────────────────╯${NC}"
...
echo -e "${LN}╔════════════════════════════════════════════════════════════╗${NC}"
echo -e "${LN}║${NC}                                                            ${LN}║${NC}"
echo -e "${LN}║${NC}                🌐 ${GR}IPv6 PANEL${NC} 🌐                         ${LN}║${NC}"
echo -e "${LN}║${NC}                    💻 𝑴𝑹 𝑻𝑶𝑴 💻                           ${LN}║${NC}"
echo -e "${LN}║${NC}                                                            ${LN}║${NC}"
echo -e "${LN}╠════════════════════════════════════════════════════════════╣${NC}"
echo -e "${LN}║${NC}  ${msg}"
