...
# BUG FIX: SERVER_HOST was pointing to 'Rootjoeltom-tech/Script_joeltom' (old repo).
# Now uses SERVER_HOST from katashie.sh environment or falls back to the 𝑱𝑶𝑬𝑳_𝑻𝑶𝑴 repo.
# Replace YOUR_GITHUB with your GitHub username/org.
export SERVER_HOST="${SERVER_HOST:-https://raw.githubusercontent.com/joeltom-tech/Script_joeltom/main}"
setup_variables() {
