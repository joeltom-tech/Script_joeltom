#!/usr/bin/env python3
"""
𝑱𝑶𝑬𝑳_𝑻𝑶𝑴 — Bot Telegram Principal v1
...
CONFIG_PATH = os.environ.get('𝑱𝑶𝑬𝑳_𝑻𝑶𝑴_BOT_CONFIG', '/etc/joeltom_bot/config.json')
...
if not BOT_TOKEN:
    raise SystemExit('Missing Telegram bot token. Set 𝑱𝑶𝑬𝑳_𝑻𝑶𝑴_BOT_CONFIG or /etc/katashie_bot/config.json')
...
BANNER = "🛡 <b>𝑱𝑶𝑬𝑳_𝑻𝑶𝑴</b> — Panel Telegram\n📲 @joeltom23"
...
if __name__ == '__main__':
    logger.info("𝑱𝑶𝑬𝑳_𝑻𝑶𝑴 Bot v1 starting...")
